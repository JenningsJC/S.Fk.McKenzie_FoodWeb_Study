...
seasonal_biomass_logged_transformed <- decostand(seasonal_biomass_log, "total")
...
ordilabel(biomass_NMDS, display = "sites", font = 3, fill = "hotpink",
...
orditorp(biomass_NMDS,display="species",col="red",air=0.01)
orditorp(biomass_NMDS,display="sites",cex=1.25,air=0.5)
